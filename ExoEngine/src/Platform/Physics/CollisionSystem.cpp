...
#include "ECS/ExoEngine/Components/Components.h"
...
namespace EM {
    ...
    void CollisionSystem::Update(float dt) {
        std::cout << "Running collision checks\n";
            ...
            for (auto const& j : mEntities) {
                ...
                if (i != j && l > k) {
                    ...
                    if (distance(ent1pos, ent2pos) < 4) {
                        ...
                        std::cout << "e1: " << (int)rigid1.GetCollider() << "\n";
                        std::cout << "e2: " << (int)rigid2.GetCollider() << "\n";
