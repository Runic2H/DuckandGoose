...
namespace EM
{
	...
	****************************************************************************/
	AABBCollider::AABBCollider() : mCol{ ColliderType::none }, mMin{ vec2D(1.0f,1.0f) }, mMax{ vec2D(1.0f,1.0f) }, mRadius{ 0.3f }, mHit{ 0 }, mCollisionNormal{ vec2D() }, is_Alive{true} {}
	/*!*************************************************************************
	This function de-serializes the level colliders from the given level json file
	****************************************************************************/
	bool AABBCollider::Deserialize(const rapidjson::Value& obj)
	{
	...
	file
	****************************************************************************/
	bool AABBCollider::Serialize(rapidjson::PrettyWriter<rapidjson::StringBuffer>* writer) const
	{
		writer->StartObject();
